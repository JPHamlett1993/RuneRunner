...
@Script.Manifest(name="JP WC", description="JP AIO Miner")
public class WC extends PollingScript<ClientContext>  implements PaintListener {
    ...
    @Override
    public void start() {
        taskList.addAll(Arrays.asList(new Chop(ctx), new Fletch(ctx)));
    }
